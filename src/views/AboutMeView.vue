...
<template>
  ...
  <h1 class='masthead-heading'>Noble Peter Jansen!</h1>
</header>

<section class="introduction-section">
    <h1>Introduction</h1>
    <p>I am a student at TIP Manila, taking BSIT program, a part time marketer, and soon to be web developer.</p>
    <p>I love the internet, technology, and building beautiful things.</p>
</section>
<section class="location-section">
    <h1>Where I'm From</h1>
    <p>I'm from Balic-balic Sampaloc Manila </p>
</section>
